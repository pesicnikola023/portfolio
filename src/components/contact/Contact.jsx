...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_d7x96qt", "template_8t2urf8", formRef.current, {
        publicKey: "35ob-Ne3BhctdoFXj",
      })
      .then(
        () => {
          console.log("SUCCESS!");
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          ...
          <span>nikola.pesic023@gmail.com</span>
        </motion.div>
        <motion.div className="item">
          ...
          <div className="social">
            ...
            <a
              href="https://www.instagram.com/johnnie.pannonie/"
              target="_blank"
            >
